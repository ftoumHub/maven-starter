...
----
include::src/main/java/hello/HelloWorld.java[]
----

`src/main/java/hello/Greeter.java`
[source,java,tabsize=2]
----
include::src/main/java/hello/Greeter.java[]
----
...
[source,java,tabsize=2]
----
include::src/test/java/hello/GreeterTest.java[]
----
